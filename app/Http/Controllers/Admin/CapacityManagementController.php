...
class CapacityManagementController extends Controller
{
    ...
    private function calculateDashboardStats($offerings): array
    {
        return [
            ...
            'overcapacity' => $offerings->where('capacity_status', 'full')->count(),
            'almost_full' => $offerings->where('capacity_status', 'almost_full')->count(),
            'underutilized' => $offerings->where('capacity_status', 'underutilized')->count(),
            'optimal' => $offerings->where('capacity_status', 'optimal')->count(),
