<x-slot name="title">{{ __('lms.create_topic') }}</x-slot>

<div class="p-6 space-y-6">
    <div class="flex items-center mb-6">
        <a href="{{ route('student.discussions.forum', $forum) }}" class="mr-4 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <form action="{{ route('student.discussions.store-topic', $forum) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('student.discussions.forum', $forum) }}"
