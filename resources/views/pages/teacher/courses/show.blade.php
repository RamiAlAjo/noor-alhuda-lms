...
<x-layouts::app :title="__('Course Details')">
    ...
    <!-- Quick Actions -->
    <div class="mb-6 grid gap-4 md:grid-cols-7">
        ...
        <a href="{{ route('teacher.reports.student-progress', ['offering_id' => $section->id]) }}" class="flex items-center justify-center gap-2 rounded-xl border border-neutral-200 bg-white p-4 text-center shadow-sm transition-all hover:border-teal-500 hover:shadow-md dark:border-neutral-700 dark:bg-neutral-800">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-teal-600 dark:text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <span class="text-sm font-medium text-neutral-700 dark:text-neutral-300">{{ __('Reports') }}</span>
        </a>
    </div>
