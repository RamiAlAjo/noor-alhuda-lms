...
<x-layouts::app :title="__('Course Management')">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-neutral-900 dark:text-neutral-100">{{ __('Course Management') }}</h1>
            <p class="mt-1 text-neutral-500 dark:text-neutral-400">{{ __('Manage all courses and sections in your institution') }}</p>
        </div>
        <flux:button :href="route('admin.courses.create')" variant="primary">
        ...
        <div class="rounded-xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-neutral-900 dark:text-neutral-100">{{ $courses->total() }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-neutral-900 dark:text-neutral-100">{{ $courses->where('is_active', true)->count() }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-neutral-900 dark:text-neutral-100">{{ $courses->sum(fn($c) => $c->sections->count()) }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm text-neutral-500 dark:text-neutral-400">{{ __('Enrolled') }}</p>
                    <p class="text-xl font-bold text-neutral-900 dark:text-neutral-100">{{ $totalEnrolled ?? 0 }}</p>
                </div>
            </div>
        </div>
    </div>
